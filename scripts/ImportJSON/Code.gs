/*====================================================================================================================================*
  ...
  A library for importing JSON feeds into Google spreadsheets. Functions include:
     ...
     ImportJSONBasicAuthentication  For use by script developers to get JSON feed from URLs behind Basic Auth
...
/**
 * An advanced version of ImportJSONAdvanced to easy open urls behind Basic Auth
 *
 * @param {url}           the URL to a public JSON feed
 * @param {query}         the query passed to the include function
 * @param {parseOptions}  a comma-separated list of options that may alter processing of the data
 * @param {username}      a login for Basic Auth
 * @param {password}      a password for Basic Auth
 *
 * @return a two-dimensional array containing the data, with the first row containing headers
 */
